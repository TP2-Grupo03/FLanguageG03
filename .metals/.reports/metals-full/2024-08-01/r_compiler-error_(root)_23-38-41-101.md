...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(state_CURSOR_)
...
== Source file context for tree position ==
    ...
    30   def putBool(bool: Bool): MError[Unit] = EitherT.left(state_CURSOR_.)
...
package object MErr {
  ...
  def putBool(bool: Bool): MError[Unit] = EitherT.left(state@@.)
