...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(Stat_CURSOR_e)
...
== Source file context for tree position ==
    ...
    30   def putBool(bool: Bool): MError[Unit] = EitherT.left(Stat_CURSOR_e)
...
package object MErr {
  ...
  def putBool(bool: Bool): MError[Unit] = EitherT.left(Stat@@e)
