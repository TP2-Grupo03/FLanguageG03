...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_bool)
   ...
   symbol definition: class <error: <none>> extends  (a ClassSymbol)
      symbol package: br.unb.cic.flang.MErr
       symbol owners: class <error: <none>> -> method putBool -> package object MErr
...
== Source file context for tree position ==
    ...
    30   def putBool(bool: Bool): MError[Unit] = EitherT.left(M[_CURSOR_bool])
...
package object MErr {
  ...
  def putBool(bool: Bool): MError[Unit] = EitherT.left(M[@@bool])
